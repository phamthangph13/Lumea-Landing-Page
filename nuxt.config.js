...
export default {
  ...
  head: {
    ...
    link: [{
      ...
      {
        rel: 'stylesheet',
        href: 'https://fonts.googleapis.com/css2?family=Barlow+Condensed:ital,wght@0,300;0,400;0,500;0,600;0,700;0,800;0,900;1,400;1,700&family=Plus+Jakarta+Sans:ital,wght@0,300;0,400;0,500;0,600;0,700;0,800;1,400;1,700&display=swap'
      }
    ],
    bodyAttrs: {
  ...
  webfontloader: {
    google: {
      families: ['Barlow+Condensed:300,400,500,600,700,800,900:latin,vietnamese', 'Plus+Jakarta+Sans:300,400,500,600,700,800:latin,vietnamese']
    }
  },
