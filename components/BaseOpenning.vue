<template>
  <div ref="Openning" class="openning">
    ...
    <div ref="OpenningPortfolio" class="openning-portfolio">HOUSE OF SCENT & RITUAL</div>
...
export default {
  ...
  mounted() {
    ...
    const index = projectResponse.findIndex ? projectResponse.findIndex((content) => content.id === this.$router.history.current.params.slug) : 0
