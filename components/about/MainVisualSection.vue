        ...
        <h1 ref="HeroTitle" class="hero-title">
          <span class="pc-only">
            <span class="hero-title-read-area">
              <AppReadTitle :state="isTextSegmentState" :text="['・', 'GIÁ TRỊ CỐT LÕI', 'CĂN — GỐC VIỆT', 'MINH — TRÍ SÁNG', 'HÒA — THUẬN NHIÊN']" :sp-animation="false" :modifier="'section'" />
            </span>
          </span>
          <span class="pc-only">
            <span class="hero-title-wrapper hero-title-wrapper-01">
              ...
              <AppTextAnimation :state="isTextSegmentState" :rotate="$BASEROTATE.right" :text="'GIỮ CĂN VIỆT'" :sp-animation="false" />
            </span>
            <span class="hero-title-wrapper hero-title-wrapper-02">
              ...
              <AppTextAnimation :state="isTextSegmentState" :start="0.176" :rotate="$BASEROTATE.left" :text="'KHAI MINH'" :sp-animation="false" />
              <AppTextAnimation :state="isTextSegmentState" :start="0.4" :rotate="$BASEROTATE.left" :text="'TRÍ SÁNG'" :sp-animation="false" />
            </span>
            <span class="hero-title-wrapper hero-title-wrapper-03">
              ...
              <AppTextAnimation :state="isTextSegmentState" :start="0.42" :rotate="$BASEROTATE.right" :text="'KIẾN TẠO'" :sp-animation="false" />
              <AppTextAnimation :state="isTextSegmentState" :start="0.6" :rotate="$BASEROTATE.right" :text="'HÒA HỢP'" :sp-animation="false" />
            </span>
            <span class="hero-title-wrapper hero-title-wrapper-04">
              ...
              <AppTextAnimation :state="isTextSegmentState" :start="0.7" :rotate="$BASEROTATE.right" :text="'VIETNAMESE HOUSE OF SCENT & RITUAL'" :sp-animation="false" />
            </span>
          </span>
          <span class="sp-only">
            <span class="hero-title-wrapper hero-title-wrapper-01-sp">
              ...
              <AppTextAnimation :state="isTextSegmentState" :rotate="$BASEROTATE.right" :text="'GIỮ CĂN VIỆT'" :pc-animation="false" />
            </span>
            <span class="hero-title-wrapper hero-title-wrapper-02-sp">
              ...
              <AppTextAnimation :state="isTextSegmentState" :start="0.176" :rotate="$BASEROTATE.left" :text="'KHAI MINH'" :pc-animation="false" />
              <AppTextAnimation :state="isTextSegmentState" :start="0.4" :rotate="$BASEROTATE.left" :text="'TRÍ SÁNG'" :pc-animation="false" />
            </span>
            <span class="hero-title-wrapper hero-title-wrapper-03-sp">
              ...
              <AppTextAnimation :state="isTextSegmentState" :start="0.42" :rotate="$BASEROTATE.right" :text="'KIẾN TẠO'" :pc-animation="false" />
              <AppTextAnimation :state="isTextSegmentState" :start="0.42" :rotate="$BASEROTATE.right" :text="'HÒA HỢP'" :pc-animation="false" />
            </span>
            <span class="hero-title-wrapper hero-title-wrapper-04-sp">
              ...
              <AppTextAnimation :state="isTextSegmentState" :start="0.6" :rotate="$BASEROTATE.right" :text="'VIETNAMESE'" :pc-animation="false" />
              <AppTextAnimation :state="isTextSegmentState" :start="0.6" :rotate="$BASEROTATE.right" :text="'HOUSE'" :pc-animation="false" />
            </span>
            <span class="hero-title-wrapper hero-title-wrapper-05-sp">
              ...
              <AppTextAnimation :state="isTextSegmentState" :start="0.72" :rotate="$BASEROTATE.right" :text="'OF SCENT & RITUAL'" :pc-animation="false" />
            </span>
            <span class="hero-title-wrapper hero-title-wrapper-06-sp">
              ...
              <AppTextAnimation :state="isTextSegmentState" :start="0.84" :rotate="$BASEROTATE.right" :text="'LUMÉA ., JSC'" :pc-animation="false" />
            </span>
          </span>
        </h1>
        <div class="pc-only">
          <div class="hero-card-item">
            <AppCard
              ...
              :subtitle="'(CÔNG TY)'"
              :link="'https://lumea.vn/'"
              :desc="['CÔNG TY CP LUMÉA,', 'MSDN: 0111603726,', 'HOUSE OF SCENT & RITUAL,', 'PHÚC LA, HÀ ĐÔNG, HÀ NỘI,', 'NGÔI NHÀ HƯƠNG VIỆT.']"
              :rotate="8"
              :xspeed="0.01"
              :yspeed="0.14"
              :sp-animation="false"
