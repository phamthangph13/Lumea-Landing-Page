  ...
  <div class="intro">
    <div ref="IntroContainer" class="intro-container">
      ...
      <div ref="IntroWrapper" class="intro-wrapper">
        ...
        <p ref="IntroReadText" class="intro-read-text">LUMÉA VIỆT NAM · HOUSE OF SCENT & RITUAL</p>
          ...
          <div ref="IntroBgClip" class="intro-bg-clip">
            ...
            <h2 class="intro-title">
              <span class="intro-title-read-area">
                <AppReadTitle :state="isTextSegmentState" :text="['・', 'CÂU CHUYỆN THƯƠNG HIỆU']" :modifier="'section'" />
              </span>
              <span class="pc-only">
                <span class="intro-title-wrapper intro-title-wrapper-01">
                  <AppTextAnimation :state="isTextSegmentState" :rotate="$BASEROTATE.right" :text="'HƯƠNG CỦA CÂY CỎ, HƯƠNG CỦA CĂN NHÀ,'" :sp-animation="false" />
                </span>
                <span class="intro-title-wrapper intro-title-wrapper-02">
                  <AppTextAnimation :state="isTextSegmentState" :start="0.12" :rotate="$BASEROTATE.left" :text="'HƯƠNG CỦA TRÀ VÀ KÝ ỨC VIỆT QUA'" :sp-animation="false" />
                </span>
                <span class="intro-title-wrapper intro-title-wrapper-03">
                  <AppTextAnimation :state="isTextSegmentState" :start="0.24" :rotate="$BASEROTATE.right" :text="'NHIỀU THẾ HỆ. CHÚNG TÔI ĐƯA GIÁ TRỊ'" :sp-animation="false" />
                </span>
                <span class="intro-title-wrapper intro-title-wrapper-04">
                  <AppTextAnimation :state="isTextSegmentState" :start="0.36" :rotate="$BASEROTATE.left" :text="'VĂN HÓA VÀO ĐỜI SỐNG THẾ HỆ MỚI'" :sp-animation="false" />
                </span>
                <span class="intro-title-wrapper intro-title-wrapper-05">
                  <AppTextAnimation :state="isTextSegmentState" :start="0.48" :rotate="$BASEROTATE.right" :text="'BẰNG KHOA HỌC & TRẢI NGHIỆM ĐƯƠNG ĐẠI.'" :sp-animation="false" />
                </span>
              </span>
              <span class="sp-only">
                <span class="intro-title-wrapper intro-title-wrapper-sp-01">
                  <AppTextAnimation :state="isTextSegmentState" :start="0" :rotate="$BASEROTATE.right" :text="'HƯƠNG CỦA CÂY CỎ'" :pc-animation="false" />
                </span>
                <span class="intro-title-wrapper intro-title-wrapper-sp-02">
                  <AppTextAnimation :state="isTextSegmentState" :start="0.12" :rotate="$BASEROTATE.left" :text="'HƯƠNG CỦA CĂN NHÀ'" :pc-animation="false" />
                </span>
                <span class="intro-title-wrapper intro-title-wrapper-sp-03">
                  <AppTextAnimation :state="isTextSegmentState" :start="0.24" :rotate="$BASEROTATE.right" :text="'HƯƠNG TRÀ & KÝ ỨC'" :pc-animation="false" />
                </span>
                <span class="intro-title-wrapper intro-title-wrapper-sp-04">
                  <AppTextAnimation :state="isTextSegmentState" :start="0.36" :rotate="$BASEROTATE.left" :text="'ĐƯA GIÁ TRỊ VĂN HÓA'" :pc-animation="false" />
                </span>
                <span class="intro-title-wrapper intro-title-wrapper-sp-05">
                  <AppTextAnimation :state="isTextSegmentState" :start="0.48" :rotate="$BASEROTATE.right" :text="'VÀO ĐỜI SỐNG MỚI'" :pc-animation="false"> </AppTextAnimation>
                </span>
                <span class="intro-title-wrapper intro-title-wrapper-sp-06">
                  <AppTextAnimation :state="isTextSegmentState" :start="0.6" :rotate="$BASEROTATE.left" :text="'ĐƯƠNG ĐẠI.'" :pc-animation="false" />
                </span>
              </span>
            </h2>
            <p class="intro-note">
              <span class="pc-only">
                TRONG MỘT THẾ GIỚI CÀNG HIỆN ĐẠI VÀ SỐ HÓA, LUMÉA MỞ RA HÀNH TRÌNH TÌM VỀ CỘI NGUỒN QUA NGHỆ THUẬT MÙI HƯƠNG BẢN ĐỊA. ĐẦU TƯ BÀI BẢN VỚI SỰ BẢO TRỢ TỪ CÁC VIỆN NGHIÊN CỨU CHUYÊN SÂU, TẠO RA CÁC LÕI CÔNG THỨC CHUẨN CHỈNH, AN TOÀN VÀ ĐẬM NÉT TINH HOA VĂN HÓA VIỆT.
              </span>
              <span class="sp-only">
                LUMÉA mở ra hành trình tìm về cội nguồn qua nghệ thuật mùi hương và trải nghiệm đương đại, với các lõi công thức chuẩn mực được nghiên cứu bài bản cùng các viện nghiên cứu chuyên sâu.
              </span>
            </p>
          </div>
        </div>
