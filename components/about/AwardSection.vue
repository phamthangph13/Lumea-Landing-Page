      ...
      <div class="award-inner">
        <div class="l-container">
          <span class="award-title-read-area">
            <AppReadTitle :state="isTextSegmentState" :text="['・', 'TIÊU CHUẨN & NỀN TẢNG']" :modifier="'award-section'" />
          </span>
          ...
          <div class="pc-only">
            <ul class="award-total-list">
              <li class="award-total-item">TIÊU CHUẨN KHOA HỌC & R&D</li>
              <li class="award-total-item">LÕI CÔNG THỨC ĐƯƠNG ĐẠI</li>
              <li class="award-total-item">BẢO TRỢ BỞI VIỆN CHUYÊN SÂU</li>
            </ul>
          </div>
        </div>
      </div>
