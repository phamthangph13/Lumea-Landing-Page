        ...
        <div class="l-container">
          <div class="project-contents">
            <div class="project-title-read-area">
              <AppReadTitle :state="isTextSegmentState" :text="['・', 'HỆ THỐNG', 'TRỤ CỘT']" :modifier="'about-project-section'" />
            </div>
                  ...
                  <div ref="ProjectItemWrapperTranslate" class="project-item-wrapper-translate">
                    ...
                    >
                      ...
                      <span ref="ProjectItemWrapper" class="project-item-wraper">
                        <!--アーカイブページの時-->
                        <AppPageTransitionBg v-if="index === projectAndArchiveData.length - 1.0" :url="`/archive`" :color="'#2c3e30'" class="project-link">HỆ SINH THÁI </AppPageTransitionBg>
                        <!--アーカイブページ以外の時-->
