      ...
      <div class="l-container">
        <h1 class="hero-title">
          <span class="hero-title-read-area">
            <AppReadTitle :state="isTextSegmentState" :text="['・', 'THƯƠNG HIỆU : LUMÉA VIỆT NAM', 'TRIẾT LÝ : CĂN · MINH · HÒA', 'CONCEPT : HOUSE OF SCENT & RITUAL', 'NGUỒN GỐC : VIỆT NAM']" :modifier="'section'" />
          </span>
          <span class="pc-only">
            ...
            <span class="hero-title-wrapper hero-title-wrapper-02">
              ...
              <span class="hero-title-wrapper-02-base-area">
                ...
                <span class="hero-title-wrapper-02-base-area-helvetica hero-title-wrapper-02-base-area-helvetica-allways">
                  <AppTextAnimation :state="isTextSegmentState" :start="0.432" :rotate="$BASEROTATE.left" :text="'ĐƯƠNG ĐẠI'" :sp-animation="false" />
                </span>
              </span>
            </span>
          ...
          <span class="sp-only">
            <span class="hero-title-wrapper hero-title-wrapper-01-sp">
              ...
              <AppTextAnimation :state="isTextSegmentState" :rotate="$BASEROTATE.right" :text="'LUMÉA'" :pc-animation="false" />
            </span>
            <span class="hero-title-wrapper hero-title-wrapper-02-sp">
              ...
              <AppTextAnimation :state="isTextSegmentState" :start="0.176" :rotate="$BASEROTATE.left" :text="'HOUSE OF SCENT'" :pc-animation="false" />
            </span>
            <span class="hero-title-wrapper hero-title-wrapper-03-sp">
              ...
              <AppTextAnimation :state="isTextSegmentState" :start="0.264" :rotate="$BASEROTATE.right" :text="'& RITUAL'" :pc-animation="false" />
            </span>
            <span class="hero-title-wrapper hero-title-wrapper-04-sp">
              <AppTextAnimation :state="isTextSegmentState" :start="0.352" :rotate="$BASEROTATE.left" :text="'( HÀNH TRÌNH TÌM VỀ CỘI NGUỒN )'" :pc-animation="false" />
              <span class="hero-title-wrapper-04-01-sp">
                <AppTextAnimation :state="isTextSegmentState" :start="0.432" :rotate="$BASEROTATE.left" :text="'CĂN BẢN'" :pc-animation="false" />
              </span>
              <span class="hero-title-wrapper-04-02-sp">
                <AppTextAnimation :state="isTextSegmentState" :start="0.512" :rotate="$BASEROTATE.left" :text="'ĐƯƠNG ĐẠI'" :pc-animation="false" />
              </span>
            </span>
            <span class="hero-title-wrapper hero-title-wrapper-05-sp">
              ...
              <AppTextAnimation :state="isTextSegmentState" :start="0.592" :rotate="$BASEROTATE.right" :text="'TRÂN TRỌNG'" :pc-animation="false" />
            </span>
            <span class="hero-title-wrapper hero-title-wrapper-06-sp">
              ...
              <AppTextAnimation :state="isTextSegmentState" :start="0.672" :rotate="$BASEROTATE.left" :text="'BẢN SẮC VIỆT'" :pc-animation="false" />
            </span>
            <span class="hero-title-wrapper hero-title-wrapper-07-sp">
              ...
              <AppTextAnimation :state="isTextSegmentState" :start="0.752" :rotate="$BASEROTATE.right" :text="'SÁNG TẠO TRI THỨC'" :pc-animation="false" />
            </span>
          </span>
        </h1>
        <div ref="HeroCardItem" class="hero-card-item">
          <AppCard
            ...
            :title="'LUMÉA'"
            :subtitle="'(TRIẾT LÝ)'"
            :desc="['HƯƠNG CỦA CÂY CỎ,', 'HƯƠNG CỦA CĂN NHÀ,', 'HƯƠNG CỦA TRÀ,', 'HƯƠNG CỦA KÝ ỨC', 'VÀ TÂM HỒN VIỆT.']"
            :rotate="8"
            :xspeed="0.01"
            :yspeed="0.14"
