      ...
      <div class="project-inner">
        <h2 ref="ProjectLoopTitle" class="project-loop-title">
          <span class="project-loop-title-read-area">
            <AppReadTitle :state="isTextSegmentState" :text="['・', 'HỆ SINH THÁI', 'LUMÉA']" :modifier="'project-section'" />
          </span>
          <span class="project-loop-title-wrapper project-loop-title-wrapper-01">
            ...
            <AppLoopText :loop="isLoopTextState" :text="'HÀNH TRÌNH TÌM VỀ CỘI NGUỒN — VIETNAMESE HOUSE OF SCENT & RITUAL.'" />
          </span>
          <span class="project-loop-title-wrapper project-loop-title-wrapper-01">
            <AppBounceLine :state="isTextUnderlineState" :start="0.24" :width="1280" :origin="'right'" :modifier="'index-project-02'" />
            <AppLoopText :loop="isLoopTextState" :direction="'left'" :text="'CĂN · GỐC VIỆT — MINH · TRÍ SÁNG — HÒA · THUẬN NHIÊN.'" />
          </span>
        </h2>
              ...
              <div>
                <div class="project-card-item" :class="`project-card-item-0${projectData.length}`">
                  <AppCard
                    ...
                    :name="'HỆ THỐNG'"
                    :title="'LUMÉA'"
                    :desc="`TỔNG HỢP CÁC TRỤ CỘT, CONCEPT VĂN HÓA VÀ NỀN TẢNG THƯƠNG HIỆU LUMÉA.`"
                    :rotate="8"
                    :xspeed="0.18"
                    :yspeed="0.17"
                  />
