        ...
        <div class="hero-title" :style="`color:${currentProject.siteColor.mvTextColor};`">
          <h1 class="hero-title-read">
            <span class="hero-title-read-area">
              <AppReadTitle :state="isTextSegmentState" :text="['・', `CONCEPT 0${currentProject.index}`]" :sp-animation="false" :modifier="'works-section'" />
            </span>
      ...
      <div class="sp-only">
        <div class="hero-textarea-sp">
          <div class="hero-index-sp" :style="`color:${currentProject.siteColor.mvTextColor};`">
            <AppReadTitle :state="isTextSegmentState" :text="['・', `CONCEPT 0${currentProject.index}`]" :pc-animation="false" :modifier="'section'" />
          </div>
