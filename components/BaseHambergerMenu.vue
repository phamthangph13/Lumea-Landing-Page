    ...
    <div ref="HambergerMenuOverlay02" class="hambergerMenu-overlay-02">
      <div ref="HambergerMenuContents" class="hambergerMenu-contents">
        <div class="hambergerMenu-title">
          <div class="hambergerMenu-title-wrapper-01 js-click-target" @click="hambergerMenuOnClose">
            <AppPageTransitionBg url="/" color="#f0efeb">
              <AppTextAnimation :state="isTextSegmentState" :rotate="$BASEROTATE.right" :text="'LUMÉA'" />
            </AppPageTransitionBg>
          </div>
        ...
        <div class="hambergerMenu-section-title">
          <AppReadTitle :state="isTextSegmentState" :start="0.24" :text="['・', 'HỆ SINH THÁI']" :modifier="'section'" />
        </div>
        <div>
            ...
            <li v-for="(data, index) in projectAndArchiveDatas" :key="index" class="hambergerMenu-item">
              <div ref="HambergerMenuItemWrapper" class="hambergerMenu-item-wrapper js-click-target" @click="hambergerMenuOnClose">
                ...
                <AppPageTransitionBg v-if="index === projectAndArchiveData.length - 1.0" :url="`/archive`" :color="'#2c3e30'" class="hambergerMenu-item-link">
                  ...
                  <span>
                    <span class="hambergerMenu-item-title">HỆ SINH THÁI</span>
                    <span class="hambergerMenu-item-desc"> TỔNG HỢP CÁC TRỤ CỘT, CONCEPT VĂN HÓA VÀ NỀN TẢNG THƯƠNG HIỆU LUMÉA. </span>
                  </span>
                </AppPageTransitionBg>
                <!--アーカイブページ以外の時-->
